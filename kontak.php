                ...
                <div class="contact-info">
                    <ul class="list-group">
                        <li class="list-group-item">
                            <strong>No WhatsApp:</strong> <a href="https://wa.me/6285155303052" target="_blank">0809-5980-111</a>
                        </li>
                        <li class="list-group-item">
                            <strong>Instagram:</strong> <a href="" target="_blank">@hakyx</a>
                        </li>
                        <li class="list-group-item">
                            <strong>Email:</strong> <a href="hakoo@gmail.com">zhaki@gmail.com</a>
                        </li>
                    </ul>
                </div>
